...
namespace PseudoEnumerableTask.Tests.NUnitTests
{
    ...
    public class EnumerableSequencesMethodsWithDelegateTestFixture
    {
        ...
        [TestCase(
            new[]
            {
                -9.56, 67.908, 45.34, 0.123, -100.453,
            },
            new[]
            {
                0.123, -9.56, 45.34, 67.908, -100.453,
            })]
        ...
        [TestCase(
            new[]
            {
                "one", "two", "three", "four", null, "five", "six", "seven", "eight", null, "nine", "ten",
            },
            new[]
            {
                null, null, "one", "two", "six", "ten", "four", "five", "nine", "three", "seven", "eight",
            })]
        ...
        [TestCase(
            new[]
            {
                12, 56, -907, 567, 234, -576, -43253, 1234,
            },
            new[]
            {
                12, 56, 567, 234, 1234,
